...
# Load required library and the raw segment-level data
```{r}
...
# Data integrity checks: Remove problematic observations (e.g., from prelim releases), standardize data, etc
```{r}
