...
- **Diver_CleanData.rmd**
  - do sanity checks and an initial clean-up on the raw data downloaded from WRDS 
    - to get the data ready for further processing and analysis  
      (e.g., for constructing new variables to be used for regression analysis)
  - save the cleaned data as **segmentHist_cleanExample.rds**
    - a file in R's native dataset format (.rds)
...
- **Diver_Measures.Rmd**
  ...
  - _merge_ the segment-level and firm-level data and construct the required variables
