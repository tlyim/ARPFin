...
- most reports fall in the _*40's to low 70's*_ mark range
  - see a report in the shared folder that earned below 40
- very, very occasionally, there were reports in low to mid 80's 



## Help me to give you higher marks

- I always want to get higher marks 
  - but I need to let the _*internal second marker*_ and the _*external examiner*_ know the rationales for giving the marks
- For example, 
...
- For example, 
  - a report on a theme group about accounting restatements 
    - had a review of the related literature that contains not a single article mentioning 'restatement' in the title; 
    - repeatedly misspelt 'restatement' as 'reinstatment'.
  - The quality of the report was in line with the student's low participation in the module: 
    ...
    - Submitted a very brief project proposal. I warned: 
    ...
    - Never submitted the milestone Methodology chapter or responded to submission reminders 
